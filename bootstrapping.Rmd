...
var_hist <- ggplot(var_est_df, aes(x=VaR)) +
  geom_histogram(aes(y = after_stat(density)),
                 ...
                 bins=30) +
  labs(
    title='Bootstrapped Estimates of Value at Risk w/ 95% CIs',
    x='returns',
    y='density'
    ) +
  geom_vline(xintercept=var_est$mean, linetype='dashed') +
...
es_hist <- ggplot(es_est_df, aes(x=ES)) +
  geom_histogram(aes(y = after_stat(density)),
                 ...
                 bins=30) +
  labs(
    title='Bootstrapped Estimates of Expected Shortfall w/ 95% CI',
    x='returns',
    y='density'
    ) +
  geom_vline(xintercept=es_est$mean, linetype='dashed') +
